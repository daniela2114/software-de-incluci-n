...
<body>
    <div class="container">
        <div class="titulo">
            <a href="../inicio.php" class="salir"><i class="fas fa-arrow-left"></i></a> 
...
<div class="menu-desplegable-content2" id="menu-desplegable2">
    <a onclick="return eliminar3()" href="../inicio.php?idEliminar3=<?php echo $datos['idEst']; ?>&anexo=1" class="imprimir"><i class="fas fa-trash"></i> anexo1</a> 
    <a onclick="return eliminar4()"href="../inicio.php?idEliminar4=<?php echo $datos['idEst']; ?>&anexo=2" class="imprimir"><i class="fas fa-trash"></i> anexo2</a> 
    <a onclick="return eliminar5()"href="../inicio.php??idEliminar5=<?php echo $datos['idEst']; ?>&anexo=3" class="imprimir"><i class="fas fa-trash"></i> anexo3</a>
</div>
...
document.addEventListener("click", function(event) {
    ...
    if (menu.classList.contains("show") && !toggleButton.contains(event.target) && !menu.contains(event.target)) {
        ...
        <h1>PIAR</h1>
        <div class="buttons">
            <a href="anexo1.php?idEst=<?php echo $datos['idEst'];?>" class="button">anexo 1 </a>

            <a href="2anexo.php?idEst=<?php echo $datos['idEst'];?>" class="button">anexo 2 </a>
            <a href="anexo3.php?idEst=<?php echo $datos['idEst'];?>" class="button">anexo 3 </a>
        </div>
