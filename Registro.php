...
include("CRUD_usuario/crearUsuario.php");
...
<body>
  <div class="container-fluid row justify-content-center">
    ...
    <h3 class="text-center text-secondary mb-3 mt-3">Registro de Profesores</h2>
      <form class="col-4" method="post" >
        ...
        <div class="d-flex flex-row  mb-4 mt-2 ">
          <div class="container">
            ...
            <button type="submit" class="btn btn-primary  ms-2" name="regisProfe">Registrar</button>
          </div>
          <div class="container ">
            <a href="http://localhost/Angelita/index.php" type="submit" class="btn btn-danger" name="cancel">Cancelar</a>
