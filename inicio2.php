...
<div class="logo">
        ...
        <nav class="navbar">
            <ul class="nav-list">
                <li class="dropdown">
                    <a href="http://localhost/Angelita/inicio2.php">Estudiante</a>
        ...
        <tr>
         ...
         <?php
            ...
            <td>
              ...
              <a href="pdf/pdfUsuar.php?idEst=<?php echo $resultado['idEst']  ?>"class="btn btn-success"><i class="fas fa-file-pdf"></i>
            </a>
            <a onclick="return eliminar2()" href="inicio2.php?idEliminar2=<?php echo $resultado['idEst']  ?>"  class="btn btn-danger" ><i class="fas fa-trash"></i>
          </a>
